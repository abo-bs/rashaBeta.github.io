...
<html style="height:auto">
	<head>
		<title><?php echo _('Error 404'); ?> | <?php echo $config['nom']; ?></title>
	...
	<body>
		...
		<div class="login">
			<div class="well">
				<h3 class="error"><?php echo _('Error 404'); ?></h3><hr>
				<h5 style="color:#f00"><?php echo _('Sorry, but this page doesn\'t exist.'); ?></h5>
			</div>
